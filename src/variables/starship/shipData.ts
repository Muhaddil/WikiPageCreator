interface ShipType {
  cost: { Small?: string; Medium?: string; Large?: string };
  slots: { Small?: string; Medium?: string; Large?: string };
  techslots: { Small?: string; Medium?: string; Large?: string };
  subtypes: string[];
  secParts: string[];
  accessories: string[];
  miscParts: string[];
  sections: { inventoryInput: string[]; [key: string]: string[] };
}
