...
<template>
  <SanitisedTextInput v-model="name" help-img="base/baseName" help-title="Nombre del Circuito"
  ...
  <TextareaInput v-model="appearance" label="Descripción general de la pista:" />

  <TextareaInput v-model="features2" label="Características del Circuito:" />
