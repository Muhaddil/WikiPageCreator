...
<template>
  <SanitisedTextInput v-model="name" help-img="mineral/mineralName" help-title="Nombre del Mineral"
  ...
  <SanitisedTextInput v-model="metalContent" label="Contenido de metales:"
    tooltip="Encontrado en el escaneo de minerales." help-img="mineral/content" help-title="Contenido metálico"
    :invalid="isContentInvalid" error-message="Sólo debe contener números" maxlength="2">Encontrado en el escaneo de
  ...
  <SanitisedTextInput v-model="polymorphic" label="Polimórfico (número de instancias):" maxlength="2"
    :invalid="isPolymorphicInvalid" error-message="Sólo debe contener números" help-title="Polimorfismo"
    tooltip="Cuántos modelos diferentes de este mineral se descubrieron.">A veces, varios modelos de minerales tienen el
    mismo nombre. Esto se llama "polimorfismo". Introduzca el
